<template>
	<div>
		<div class="dc_filter">
			<el-input v-model="query.name" placeholder="请输入要查询的能源名称"></el-input>
		...
		<el-table :data="tableData.records" border>
			...
			<el-table-column label="工序号" prop="procedureId">
			...
			<el-table-column label="能源类型" prop="energyType"></el-table-column>
			<el-table-column label="能源名称" prop="energyName"></el-table-column>
			<el-table-column label="单价" prop="energyPrice"></el-table-column>
			<el-table-column label="用量" prop="energyNumber"></el-table-column>
			<el-table-column label="总计" prop="allCost"></el-table-column>
